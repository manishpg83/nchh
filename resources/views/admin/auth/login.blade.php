...
<head>
    ...
    <title>NC Health Hub | Admin</title>
...
<body>
                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="{{ asset('images/favicon/neucrad.png') }}" alt="logo" width="50" class="shadow-light rounded-circle">
                        </div>
                        ...
                        <div class="card card-primary">
                            ...
                            @endif
                            <div class="card-body">
                                <form method="POST" action="{{$loginRoute}}" id="loginForm" class="needs-validation" novalidate="">
                                    @csrf
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input id="email" type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" tabindex="1" required autofocus placeholder="Your Email Address">
                                        @if ($errors->has('email'))
    ...
    <script src="{{asset('account/js/stisla.js')}}"></script>
