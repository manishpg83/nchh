<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        ...
        <form id="drugForm" action="{{route('admin.drug.update',$drug->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="modal-body pb-0">
                <div class="form-group mb-0 row">
                    ...
                    <div class="col-sm-3 mb-2">
                        ...
                        <textarea class="form-control p-1" name="instructions" id="instructions">{{$drug->instructions}}</textarea>
                        <span class="text-danger">
