<div class="modal-dialog modal-lg" role="document" id="viewuser">
    <div class="modal-content">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <p class="mt-2">Specialty : {{$user->detail->specialty_name}}</p>
                        <p class="mt-2">Gender : {{$user->gender}}</p>
                        <p class="mt-2">City : {{$user->city}}</p>
                    </div>
                    <div class="col-sm-6">
                        <strong>Medical Registration Details</strong>
                        <p class="mt-2">Registration Number : {{$user->detail->registration_number}}</p>
                        <p class="mt-2">Registration Year : {{$user->detail->registration_year}}</p>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class="mt-2">Degree : {{$user->detail->degree}}</p>
                        <p class="mt-2">College/Institute : {{$user->detail->collage_or_institute}}</p>
                        <p class="mt-2">Year Of completion : {{$user->detail->year_of_completion}}</p>
                        <p class="mt-2">Year of experience : {{$user->detail->experience}}</p>
                    </div>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <strong>Medical Registration Proof</strong>
                        <img src="{{$user->detail->medical_registration_proof}}"
                            class="imagePreview thumbnail pt-2 w-100" id="preview" alt="Medical registration proof" />
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="modal-footer">
            <button type="button" onclick="verifyDoctorDetail({{$user->id}},'approved');"
                class="btn btn-mat btn-success btn-sm">Approved</button>
            <button type="button" onclick="verifyDoctorDetail({{$user->id}},'reject');"
