                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered nowrap" id="agentVerificationTable"
                                width="100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
...
var agentVerificationTable;
var dataTableModal = $('#dataTableModal');

var getAgentVerificationList = "{{Route('admin.agent.profile.verification')}}";
var getAgentDetailUrl = "{{Route('admin.check.agent.detail',[':slug'])}}";
var verifyAgentDetailUrl = "{{Route('admin.agent.profile.verify')}}";
</script>
@endsection