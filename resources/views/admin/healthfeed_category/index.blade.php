...
<script type="text/javascript">
    ...
    //url
    var getCategoryList = "{{Route('admin.healthfeed_category.index')}}";
    var addCategoryUrl = "{{route('admin.healthfeed_category.create')}}";
    var editCategoryUrl = "{{route('admin.healthfeed_category.edit',[':slug'])}}";
    var deleteCategoryUrl = "{{route('admin.healthfeed_category.destroy',[':slug'])}}";
</script>
@endsection