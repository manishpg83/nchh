...
<script type="text/javascript">
    ...
    //url
    var getTypeList = "{{Route('admin.drug-types.index')}}";
    var addTypeUrl = "{{route('admin.drug-types.create')}}";
    var editTypeUrl = "{{route('admin.drug-types.edit',[':slug'])}}";
    var deleteTypeUrl = "{{route('admin.drug-types.destroy',[':slug'])}}";
</script>
@endsection