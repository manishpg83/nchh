...
<script type="text/javascript">
    ...
    //url
    var getUnitList = "{{Route('admin.drug-units.index')}}";
    var addUnitUrl = "{{route('admin.drug-units.create')}}";
    var editUnitUrl = "{{route('admin.drug-units.edit',[':slug'])}}";
    var deleteUnitUrl = "{{route('admin.drug-units.destroy',[':slug'])}}";
</script>
@endsection