<div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
		...
		<form id="reportForm" action="{{route('front.report.store')}}" method="post" enctype="multipart/form-data">
			@csrf
				...
				<div class="card-body">
					<div class="form-group row">
						...
						<div class="col-sm-3 mb-2">
							<div id="imagePreview">
								<img src="{{asset('images/d_default.png')}}" class="imagePreview thumbnail w-100 pt-2" id="preview"/>
							</div>
						</div>
						...
						<div class="col-sm-6 mb-2">
							...
							<input type="text" name="name" class="form-control" id="name" placeholder="Enter article title">
							<span class="text-danger">
						...
						<div class="col-sm-12 mb-2">
							...
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="type" id="report" value="report" checked>
								<label class="form-check-label" for="report">Report</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="type" id="prescription" value="prescription">
								<label class="form-check-label" for="prescription">Prescription</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="type" id="invoice" value="invoice">
