												...
												<td align="center">
													<table class="insider" width="348" border="0" align="center" cellpadding="0" cellspacing="0">
														...
														<tr>
															...
															<br>
															<br>
															You are confirm appointment on {{date('l jS F', strtotime($appointment_time))}} at {{$diagnostics_name}} at {!!$diagnostics_address!!}. 
															<br>
															<br>
															Thanks for schedule with {{$diagnostics_name}}
															<br>
															Regards,                            
															<br>
															Team
