								...
								<td align="center">
									<table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style=" border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
										<tbody>
											...
											<tr>
												<td align="right">
													<table width="598" border="0" align="left" cellpadding="0" cellspacing="0" class="col2">
														<tbody>
															<tr>
																<td>
																	<table class="insider" width="450" border="0" align="center" cellpadding="0" cellspacing="0">
																		<tbody>
																			<tr align="left">
																				<td style="font-family: 'Raleway', sans-serif; font-size:23px; color:#2a3b4c; line-height:30px; font-weight: bold;">You have been invited to NC Health Club.</td>
																			</tr>
																			<tr>
																				<td height="10"></td>
																			</tr>
																			<tr>
																				<td style="font-family: 'Lato', sans-serif; font-size:16px; color:#2a3b4c; line-height:15px; font-weight: 300;">
																					Hey,
																					<p style="font-family: 'Lato', sans-serif; font-size:14px; color:#2a3b4c; line-height:15px; font-weight: 300;padding-left: 30px;">{!!$content!!}</p>
																				</td>
																			</tr>
																			@if($referral_link)
																			<tr align="center">
																				<td>
																					<h1>Referral Code : <strong>{{$referral_code}}</strong></h1>
																				</td>
																			</tr>
																			<tr align="center">
																				<td>
																					<a href="{{$referral_link}}" style="display: inline-block;color: #fff;padding: 10px 20px;width: 170px;text-align: center;margin-right: 10px;margin-bottom: 10px;font-size: 14px;font-weight: bold;line-height: 20px;text-decoration: none;border-radius: 3px;background-color: #ed9b2d;">Create Account</a>
																				</td>
																			</tr>
																			<tr align="center">
																				<td>
																					<p style="margin-top: 10px;">
																						In case you are unable to view the button, please copy and paste the following link in the browser: <br>
																			...
																			@endif
																			<tr align="left">
																				<td style="font-family: 'Raleway', sans-serif; font-size:15px; color:#2a3b4c; line-height:30px; font-weight: bold;">
																					<b>Regards,</b> <br>
																					{{$sender_user}} & Team!
																				</td>
																			</tr>
