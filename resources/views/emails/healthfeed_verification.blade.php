		...
		<tbody><tr>
			<td align="center">
				<table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
					<tbody><tr>
						<td align="center" valign="top" bgcolor="#66809b" style="background-size:cover; background-position:top;height:400">
							<table class="col-600" width="600" height="400" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000">
								...
								<tr>
									<td align="center" style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:24px; font-weight: bold; letter-spacing: 7px;">
										NC <span style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:39px; font-weight: 300; letter-spacing: 7px;">Health Hub</span>
									</td>
								</tr>
								...
								<tr>
									<td align="right">
										...
										<table class="col2" width="200" border="0" align="right" cellpadding="0" cellspacing="0">
											<tbody><tr>
												<td align="center" style="line-height:0px;">
													<img style="display:block; line-height:0px; font-size:0px; border:0px;" class="images_style" src="http://74.207.248.179/neucrad/public/images/health.png" width="150" height="150">
												</td>
											</tr>
										</tbody></table>
										...
										<table width="398" border="0" align="left" cellpadding="0" cellspacing="0" class="col2">
											<tbody><tr>
												<td align="center">
													<table class="insider" width="348" border="0" align="center" cellpadding="0" cellspacing="0">



														<tbody><tr align="left">
															<td style="font-family: 'Raleway', sans-serif; font-size:23px; color:#2a3b4c; line-height:30px; font-weight: bold;">Dear Admin,</td>
														</tr>
														...
														<tr>
                                                        <td style="font-family: 'Lato', sans-serif; font-size:16px; color:#2a3b4c; line-height:15px; font-weight: 300;">
																			<p style="font-family: 'Lato', sans-serif; font-size:14px; color:#2a3b4c; line-height:15px; font-weight: 300;padding-left: 30px;">
																			{!!$content!!}
																			<br>
																			<tr align="center">
																				<td>
																					<a href="{{route('admin.healthfeed.healthfeed-verification')}}" style="display: inline-block;color: #fff;padding: 10px 20px;width: 170px;text-align: center;margin-right: 10px;margin-bottom: 10px;font-size: 14px;font-weight: bold;line-height: 20px;text-decoration: none;border-radius: 3px;background-color: #ed9b2d;">Verify HealthFeed</a>
																				</td>
																			</tr>
																			<br>
																			Kindly, request to you please approve my feed and let me know if any concern about the same.
																			<br><br>
																			Thanks!
																			</p>
																		</td>
								...
								<tr>
									...
									<td align="center" bgcolor="#34495e">
										<table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
											...
											<tr>
												<td align="center" style="font-family: 'Raleway', sans-serif; font-size:20px; color:#f1c40f; line-height:24px; font-weight: bold;">Need help with your appointment? </td>
											</tr>
