											...
											<tbody><tr>
												<td align="center">
													<table class="insider" width="348" border="0" align="center" cellpadding="0" cellspacing="0">
														...
														<tbody><tr align="left">
															<td style="font-family: 'Raleway', sans-serif; font-size:23px; color:#2a3b4c; line-height:30px; font-weight: bold;">Dear {{$diagnostics_name}},</td>
														</tr>
														...
														<tr>
															...
															A new appointment has been booked for {{date('l jS F', strtotime($appointment_time))}}. the patient details mentioned below.<br>
