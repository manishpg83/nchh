								...
								<tr>
									<td align="right">
										...
										<table width="598" border="0" align="left" cellpadding="0" cellspacing="0" class="col2">
											<tbody><tr>
												<td align="center">
													<table class="insider" width="548" border="0" align="center" cellpadding="0" cellspacing="0">



														<tbody><tr align="left">
															<td style="font-family: 'Raleway', sans-serif; font-size:23px; color:#2a3b4c; line-height:30px; font-weight: bold;">New User Register</td>
														</tr>
														...
														<tr>
															...
															New user has registered on your website.<br>
															Please click on button to view more detail about user.<br>
															<br>
															<a href="{{route('admin.user.index')}}" style="display: inline-block;color: #fff;padding: 10px 20px;width: 170px;text-align: center;margin-right: 10px;margin-bottom: 10px;font-size: 14px;font-weight: bold;line-height: 20px;text-decoration: none;border-radius: 3px;background-color: #59ce57;position: absolute;left: 43%;">View User</a>
															<br>
															Thanks.
															</td>
														</tr>
