								...
								<tr>
									<td align="right">
										...
										<table class="col2" width="200" border="0" align="right" cellpadding="0" cellspacing="0">
											<tbody><tr>
												<td align="center" style="line-height:0px;">
													<img style="display:block; line-height:0px; font-size:0px; border:0px;" class="images_style" src="http://74.207.248.179/neucrad/public/images/calender.png" width="150" height="150">
												</td>
											</tr>
										</tbody></table>
											...
											<tbody><tr>
												<td align="center">
													<table class="insider" width="348" border="0" align="center" cellpadding="0" cellspacing="0">
														...
														<tbody><tr align="left">
															<td style="font-family: 'Raleway', sans-serif; font-size:23px; color:#2a3b4c; line-height:30px; font-weight: bold;">Dear {{$doctor_name}},</td>
														</tr>
														...
														<tr>
															...
															A new appointment has been booked for {{date('l jS F, \a\t h:i a', strtotime($appointment_time))}}. the patient details mentioned below.<br>
															Patient Name: {{$recipient_name}}<br>
															Contact No: {{$recipient_phone}}<br>

															If you are unavailable on the appointment date booked by us or want to cancel or reschedule then you can cancel the appointment from your account.<br>

															Practice Address is {!!$practice_address!!}. Ph:+91{{$practice_phone}}.<br>
