														...
														<td>
															<table class="insider" width="450" border="0" align="center" cellpadding="0" cellspacing="0">
																<tbody>
																	...
																	<tr align="center">
																		<td>
																			<a href="{{$soft_url}}" style="display: inline-block;color: #fff;padding: 10px 20px;width: 170px;text-align: center;margin-right: 10px;margin-bottom: 10px;font-size: 14px;font-weight: bold;line-height: 20px;text-decoration: none;border-radius: 3px;background-color: #ed9b2d;">Complete Your Profile</a>
																		</td>
																	</tr>
																	<tr align="center">
																		<td>
