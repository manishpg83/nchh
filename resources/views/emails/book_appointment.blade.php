											...
											<tbody><tr>
												<td align="center">
													<table class="insider" width="348" border="0" align="center" cellpadding="0" cellspacing="0">
														...
														<tbody><tr align="left">
															<td style="font-family: 'Raleway', sans-serif; font-size:23px; color:#2a3b4c; line-height:30px; font-weight: bold;">{{$title}}</td>
														</tr>
														...
														<tr>
															...
															<br>
															<br>
															You are confirm appointment on {{date('l jS F, \a\t h:i a', strtotime($appointment_time))}} EST with {{$doctor_name}} at {!!$practice_address!!}. 
															<br>
															To cancel or reschedule your appointment before the scheduled time, please click: <a href="{{route('myAppointment')}}">Here</a> 
															<br>
															<br>
															Thanks for schedule with {{$practice_name}}
															<br>
															Regards,                            
															<br>
															Team
