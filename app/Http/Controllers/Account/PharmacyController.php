...
class PharmacyController extends BaseController
{
    ...
    {
        $this->_setPageTitle('Pharmacy Profile');
        $data = [
            'title' => 'Pharmacy Profile',
            'user' => Auth::user(),
        ];

        return view("account.profiles.pharmacy.profile")->with($data);
    }
    ...
    public function storeProfile(Request $request)  {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $user->update(['as_pharmacy_verified' => '1']);
                ...
                $data = [
                    ...
                    'title' => 'User Request For Pharmacy Profile Approval',
                    'type' => 'pharmacy_profile_verification',
                ...
                if ($is_admin->email) {
                    $mailInfo = ([
                        ...
                        'title' => '',
                        'subject' => 'Apply Profile As Pharamcy ' . $user->name,
                        'content' => 'I would like to request approval for my profile as a pharmacy. I have uploaded all the details and documents.<br>
