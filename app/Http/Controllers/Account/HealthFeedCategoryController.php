...
class HealthFeedCategoryController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('account.healthfeed_category.index')->with($data);
    }
    ...
    public function create()
    {
        ...
        $html = view('account.healthfeed_category.create', $data)->render();
    ...
    public function edit($id)
    {
        ...
        $html = view('account.healthfeed_category.update', $data)->render();
